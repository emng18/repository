...
def filter_and_convert_to_csv(filename):
  ...
  if "review" in filename:
     ...
     outputFile = open('yelp_academic_dataset_review.csv', 'w',encoding='utf-8')
     ...
     outputFile = open('yelp_academic_dataset_user.csv', 'w',encoding='utf-8')
     fields= ['user_id', 'name']   
     ...
     outputFile = open('yelp_academic_dataset_business.csv', 'w',encoding='utf-8')
